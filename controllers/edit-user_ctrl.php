...
if(empty($errorsArray) ){    
    $user = new User($lastname, $firstname, $email, $password1, $password2);
    $result = $user->update($id);
    if($result===true){
        header('location: /controllers/edit-user_ctrl.php?messageCode=3');
    } else {
...
if($user){
    ...
    header('location: /controllers/edit-user_ctrl.php?msgCode=3');
}
/*************************************************************/
}
